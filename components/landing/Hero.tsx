    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-20 sm:pt-32 pb-16 sm:pb-24 text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 rounded-full border border-border bg-white px-4 py-2 text-sm text-muted shadow-sm mb-8"
        >
        ...
        <motion.div
          ...
          className="mt-8 inline-flex items-center gap-3 text-2xl sm:text-3xl font-bold"
        >
        ...
        >
          <a
            href="#contact"
            className="group flex items-center gap-2 rounded-xl bg-foreground text-white px-8 py-4 text-base font-semibold hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl"
          >
            지금 시작하기
          ...
          <a
            href="#pricing"
            className="flex items-center gap-2 rounded-xl border border-border bg-white px-8 py-4 text-base font-semibold text-foreground hover:bg-surface transition-all"
          >
            요금제 보기
          </a>
        </motion.div>
